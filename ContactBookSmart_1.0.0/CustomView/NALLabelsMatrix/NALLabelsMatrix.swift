...
class NALLabelsMatrixView : UIView {
    ...
    func addRecord(record:Array<String>, colorText: UIColor, indexColor: Int){
        ...
        paragraphStyle.firstLineHeadIndent = 7.0
...
//            }
            let attrText:NSAttributedString = NSAttributedString.init(string: record[i], attributes: [NSAttributedStringKey.paragraphStyle: paragraphStyle])
